...
//$sql= "UPDATE spl_user SET user_name = '서보람' WHERE user_idx = 1";

// 7. 데이터 삭제(delete) : DELETE FROM [field name] WHERE [field name] = [field value];
$sql = "DELETE FROM spl_user WHERE user_idx = 1 and user_name='서보람'";

// mysqli_query() : 데이터베이스에 작업을 요청하는 함수 : 첫번째 파라미터에는 접속정보, 두번째 파라미터에는 요청작업을 전달
